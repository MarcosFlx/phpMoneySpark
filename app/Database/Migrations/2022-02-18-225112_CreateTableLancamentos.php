    ...
    public function up()
    {
        ...
        $this->forge->addField([
            ...
            'notificar_por_email'                          =>[
                'type'      => 'TINYINT(1)',
                'default'   => 2,
                'coment'=>'indica se será enviado um email de notificação quando o lançamento vencer. 1 => SIM; 2 => NÃO',
            ],
            'consolidado'                          =>[
                'type'      => 'TINYINT(1)',
                'default'   => 2,
                'coment'=>'indica se o lançamento entrará nos cálculos de saldo. 1 => SIM; 2 => NÃO',
            ],
